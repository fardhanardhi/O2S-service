...
<div id="content" class="container col-md-12">
	<?php 
		...
		if(isset($_POST['btnAdd'])){
			...
			if(!empty($menu_name) && !empty($category_ID) && !empty($price) && is_numeric($price) &&
				...
				if($result){
					$error['add_menu'] = " <span class='label label-primary'>Berhasil Menambahkan</span>";
				}else {
					$error['add_menu'] = " <span class='label label-danger'>Gagal</span>";
				}
			}
	...
	?>
	<div class="col-md-12">
	<h1>Tambah Barang <?php echo isset($error['add_menu']) ? $error['add_menu'] : '';?></h1>
	<hr />
	</div>
	...
	<div class="col-md-9">
		<div class="col-md-12">
		<label>Nama barang :</label><?php echo isset($error['menu_name']) ? $error['menu_name'] : '';?>
		<input type="text" class="form-control" name="menu_name"/>
		</div>
	    <div class="col-md-3">
	    <br>
	    <label>Harga (<?php echo $currency;?>) :</label><?php echo isset($error['price']) ? $error['price']:'';?>
		<input type="text" class="form-control" name="price"/>
		<br/>

		<label>Barang :</label><?php echo isset($error['quantity']) ? $error['quantity']:'';?>
	    ...
	    <label>kategori :</label><?php echo isset($error['category_ID']) ? $error['category_ID'] : '';?>
		...
		<br/>
		<label>Gambar :</label><?php echo isset($error['menu_image']) ? $error['menu_image'] : '';?>
		<input type="file" name="menu_image" id="menu_image"/>
		</div>

		<div class="col-md-9">
		<br>
		<label>Deskripsi :</label><?php echo isset($error['description']) ? $error['description'] : '';?>
		...
		<div class="panel panel-default">
			<div class="panel-heading">Tambah</div>
				<div class="panel-body">
					<input type="submit" class="btn-primary btn" value="Tambah" name="btnAdd" />&nbsp;
					<input type="reset" class="btn-danger btn" value="Hapus"/>
				</div>
		</div>
	</div>
	</form>
