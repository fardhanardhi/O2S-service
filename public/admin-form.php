...
<div id="content" class="container col-md-12">
	...
	<div class="col-md-5">
		<form method="post">
		    ...
		    <label>Katasandi Lama :</label><?php echo isset($error['old_password']) ? $error['old_password'] : '';?>
			<input type="password" class="form-control" name="old_password"/>
			<br/>

		    <label>Katasandi Baru :</label><?php echo isset($error['new_password']) ? $error['new_password'] : '';?>
			<input type="password" class="form-control" name="new_password"/>
			<br/>

			<label>Ulangi Katasandi Baru :</label><?php echo isset($error['confirm_password']) ? $error['confirm_password'] : '';?>
			<input type="password" class="form-control" name="confirm_password"/>
			<br/>

		    <input type="submit" class="btn-primary btn" value="Ubah" name="btnChange"/>		
		</form>
	<div class="col-md-5">
