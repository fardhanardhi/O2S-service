			  ...
			  <div class="panel-body">
				...
				<br>
				    <form method="post">
							...
							<br>
							<button type="Masuk" name="btnLogin" class="btn btn-primary pull-right">Login</button><br><br>		
				    </form>
				<a href="forget-password.php"><p class="pull-right">Lupa Katasandi?</p></a>
			  </div>
			</div>
	</div>
</div>
