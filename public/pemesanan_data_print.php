...
?>
	...
	?>
		...
		<table width="100%" class="tulisan">
			<tr>
			<td>Nama : <?php echo $data['Name']; ?></td>
			</tr>
			
			<tr>
			<td>Alamat Pengiriman : <?php echo $data['Alamat']; ?></td>
			</tr>
			
			<tr>
			<td>Waktu : <?php echo $data['Date_n_Time']; ?></td>
			</tr>
		...
		<button class="btn btn-primary" onclick="fungsiprint()">Cetak</button>
