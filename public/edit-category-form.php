...
<div id="content" class="container col-md-12">
	...
	<div class="col-md-5">
		<form method="post"
			...
			<label>Ubah Nama :</label><?php echo isset($error['category_name']) ? $error['category_name'] : '';?>
			<input type="text" class="form-control" name="category_name" value="<?php echo $data['Category_name']; ?>"/>
			<br/>
			<label>Gambar :</label><?php echo isset($error['category_image']) ? $error['category_image'] : '';?>
			<input type="file" name="category_image" id="category_image" /><br />
			<img src="<?php echo $data['Category_image']; ?>" width="280" height="190"/>
			<br/><br/>
			<input type="submit" class="btn-primary btn" value="Perbarui" name="btnEdit"/>
			<input type="submit" class="btn-danger btn" value="Batal" name="btnCancel"/>
		</form>
	</div>
